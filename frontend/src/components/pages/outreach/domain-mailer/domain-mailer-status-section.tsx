...
export function DomainMailerStatusSection({ status, isLoading, cooldownTotalSeconds }: { status?: MailerStatus; isLoading?: boolean; cooldownTotalSeconds?: number }) {
  ...
  return (
    <section className="grid gap-4 lg:grid-cols-3">
      {isLoading ? (
        ...
        <>
          <MailerCapacityCard className="lg:col-span-2" title={visibleStatus.capacity.title} logoSrc="/icons/domain-capacity-logo.png" logoAlt="Domain capacity" allocated={visibleStatus.capacity.allotted} sent={visibleStatus.capacity.sent} />
