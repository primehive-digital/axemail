...
import { BotAllocationLimitDialog } from "@/components/pages/administration/allocation-management/bot-allocation-limit-dialog";
...
export function BotAllocationTableCard({
  pools,
  rows,
  bots,
  onAssignAllocation,
